...
const defaultStudentFaqs: FaqItem[] = [
  {
    ...
    answer: '英語力に自信がなくても大丈夫です。初心者向けのプログラムも多数ご用意しています。現地では実践的な英語力が自然と身につき、多くの学生が「思っていたより話せるようになった」と実感しています。授業は自分のレベルに合わせて受けられるので安心してください。'
  },
  {
    question: '友達がいなくても参加できますか？',
    answer: '一人での参加者がほとんどです。現地で多くの友達ができるチャンスでもあります。留サポでは出発前オリエンテーションを実施しているので、同じ時期に留学する仲間と事前に知り合うこともできます。一人だからこそ新しい出会いや経験が待っていますよ。'
  },
  {
    question: '留学費用はどのくらいかかりますか？',
    answer: 'プログラムの種類や期間によって異なりますが、2週間の短期プログラムであれば35万円程度から、3ヶ月の語学留学で約100万円程度からご用意しています。費用には滞在費、食費、授業料、アクティビティ費用などが含まれます。詳細は個別カウンセリングでご案内します。'
  },
  {
