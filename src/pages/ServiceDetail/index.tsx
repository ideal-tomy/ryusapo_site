...
import { Box, Container, Heading, Text, VStack, SimpleGrid, List, ListItem, ListIcon, Image, Badge, useBreakpointValue, Divider } from '@chakra-ui/react';
              ...
              <VStack spacing={10} align="center">
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      ハワイの大自然の中で、五感をフルに使ったアクティビティを体験。
                      ただ「遊ぶ」だけでなく、自然との対話を通じて自分の感性や考える力を育てます。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      自分の"好き"や"得意"を発見し、自己肯定感を高める貴重な時間です。
                    </Text>
                  </Box>
                </Box>
                ...
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      世界の同世代と一緒に、英語で社会課題について考え、発表するワークショップ。
                      英語力に自信がなくても、スタッフがしっかりサポート。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「伝える力」「考える力」「チャレンジ精神」が自然と身につきます。
                    </Text>
                  </Box>
                </Box>
                <Divider borderColor="gray.200" borderWidth={1} my={2} w="80%" />
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      1日の終わりに、仲間やスタッフと一緒に「今日の気づき」「明日の目標」を共有。
                      不安や悩みもすぐに相談できる環境で、安心して新しい挑戦を続けられます。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      心の成長と安心感が、次のチャレンジへの原動力になります。
                    </Text>
                  </Box>
                </Box>
                <Divider borderColor="gray.200" borderWidth={1} my={2} w="80%" />
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      海外大卒・留学経験豊富な日本人スタッフが常に同行。
                      体調や安全面もきめ細かくサポートし、初めての海外でも安心して過ごせます。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「もしもの時」もすぐに頼れる安心感が、思い切り挑戦できる理由です。
                    </Text>
                  </Box>
                </Box>
                <Divider borderColor="gray.200" borderWidth={1} my={2} w="80%" />
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      帰国後も「やりっぱなし」ではなく、次のステップ（現地校見学や本格留学）へしっかりサポート。
                      一人ひとりの成長や夢に合わせて、最適な進路を一緒に考えます。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「体験で終わらせない」——未来につながるサポートです。
                    </Text>
                  </Box>
                </Box>
              </VStack>
              ...
              <VStack spacing={10} align="center">
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      希望や適性を丁寧にヒアリングし、最適な学校をリストアップ。見学アポイントや日程調整もすべてお任せください。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「自分に本当に合う学校」と出会うための第一歩を、プロが徹底サポート。
                    </Text>
                  </Box>
                </Box>
                <Divider borderColor="gray.200" borderWidth={1} my={2} w="80%" />
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      日本人・バイリンガルスタッフが現地で同行し、通訳や現地生活のリアルな情報もご案内。保護者の方も安心です。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「パンフレットでは分からない」学校の空気や雰囲気を、肌で体感できます。
                    </Text>
                  </Box>
                </Box>
                <Divider borderColor="gray.200" borderWidth={1} my={2} w="80%" />
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      実際に通っている生徒や卒業生の「生の声」を直接聞ける機会をアレンジ。疑問や不安もその場で解消。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「本当に自分に合うか」を納得して選べる、唯一無二の体験です。
                    </Text>
                  </Box>
                </Box>
                <Divider borderColor="gray.200" borderWidth={1} my={2} w="80%" />
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      見学後は、感じたこと・気づきを一緒に整理。進路相談や出願・入学手続きまで一気通貫でサポートします。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「見て終わり」ではなく、未来につながるアクションまで伴走します。
                    </Text>
                  </Box>
                </Box>
                <Divider borderColor="gray.200" borderWidth={1} my={2} w="80%" />
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      移動や滞在先の手配、保護者向けのサポートも充実。初めての現地訪問でもストレスなく過ごせます。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「家族みんなが安心できる」現地校見学を実現します。
                    </Text>
                  </Box>
                </Box>
                <Divider borderColor="gray.200" borderWidth={1} my={2} w="80%" />
                <Box display="flex" alignItems="flex-start" gap={6} w="100%">
                  ...
                  <Box flex={1}>
                    ...
                    <Text fontSize={{ base: 'md', md: '28px' }} color="gray.700" fontWeight="semibold">
                      ここまで手厚いサポートを、明朗な料金体系でご提供。費用面も納得してご利用いただけます。
                    </Text>
                    <Box h={4} />
                    <Text fontSize={{ base: 'md', md: '28px' }} color="blue.600" fontWeight="bold">
                      「この価格でここまで？」と驚かれるコスパの良さを実感してください。
                    </Text>
                  </Box>
                </Box>
              </VStack>
