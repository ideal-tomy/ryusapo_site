...
見学後は進路相談や出願・入学手続きまで一気通貫。費用も明朗で、保護者の方も安心です。
    `,
    features: [
      { title: '学校選定・見学アポ取得・日程調整', img: '/images/genchi02.png', description: '希望や適性を丁寧にヒアリングし、最適な学校をリストアップ。見学アポイントや日程調整もすべてお任せください。', blue: '「自分に本当に合う学校」と出会うための一歩を、プロが徹底サポート。' },
      { title: '当日の同行・通訳', img: '/images/genchi03.png', description: '日本人・バイリンガルスタッフが現地で同行し、通訳や現地生活のリアルな情報もご案内。保護者の方も安心です。', blue: '「パンフレットでは分からない」学校の空気や雰囲気を、肌で体感できます。' },
      { title: '在学生・卒業生ネットワークでリアルな声を提供', img: '/images/genchi04.png', description: '実際に通っている生徒や卒業生の「生の声」を直接聞ける機会をアレンジ。疑問や不安もその場で解消。', blue: '「本当に自分に合うか」を納得して選べる、唯一無二の体験です。' },
      { title: '見学後のフィードバック・進路相談・出願サポート', img: '/images/genchi05.jpg', description: '見学後は、感じたこと・気づきを一緒に整理。進路相談や出願・入学手続き（別プランをご用意）まで一気通貫でサポートします。', blue: '「見て終わり」ではなく、未来につながるアクションまで伴走します。' },
      { title: '安心・快適な環境づくり（移動・滞在・保護者向け）', img: '/images/health.jpg', description: '移動や滞在先の手配、保護者向けのサポートも充実。初めての現地訪問でもストレスなく過ごせます。', blue: '「家族みんなが安心できる」現地校見学を実現します。' },
      { title: 'コスパの良さ（料金表で明示）', img: '/images/genchi06.jpg', description: 'ここまで手厚いサポートを、明朗な料金体系でご提供。費用面も納得してご利用いただけます。', blue: '「この価格でここまで？」と驚かれるコスパの良さを実感してください。' }
    ],
    priceTable: true
  },
  {
